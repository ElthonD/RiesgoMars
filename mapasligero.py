...
def createPage():
    ...
    def load_HR():
        ...
        rutaA = r'./data/Historico de Robos Mars.xlsx'
    ...
    try:
        ...
        + Icono con el Logo de Mars donde se presentan todos los robos y ubicados por Estados de la República Mexicana.
        + Información sobre el robo (Origen, Destinos, Estado, Tipo evento (Recuperado/Consumado), Mes, Día, Hora).
        """)

        df3 = load_HR()
        st.write(f"Este módulo contiene información histórica de los robos de Mars desde **{df3.Mes.values[0]} {df3.Año.values[0].astype(int)}** a **{df3.Mes.values[-1]} {df3.Año.values[-1].astype(int)}** :")
        ...
        #st.write(""" 
        #La finalidad de este módulo es visualizar las patrullas en campo junto con el comportamiento histórico de anomalías de Nestlé. 
        ...
        #mapacalor = mapa_calor(df_selected_diax, df_hr, df_patrullas)
